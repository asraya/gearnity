      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <h1 class="text-capitalize mb-4">{{$app_header_web}}</h1>
            <p class="mb-4">We have collected the best offers of credit institutions and banks
              ...
              class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">Learning path<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="ps-lg-5 text-center">
            <img loading="lazy" decoding="async"
              src="{{ asset('web') }}/assets/images/banner/banner.png"
...
<section class="section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="{{ route('frontend.course.show',[
            ...
            <div class="block"> <span class="colored-box text-center h3 mb-4">01</span>
              ...
              <p class="mb-0 service-description">{{ $course['price_rupiah'] }}</p>
                <div class="d-flex border-top">
                  <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Asep rayana</small>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="{{ asset('web') }}/assets/images/about-us.png" alt="About Ourselves" class="img-fluid">
        </div>
      </div>
    </div>
    <div class="has-shapes">
        ...
        <div class="col-lg-10">
          <ul class="payment_info_tab nav nav-pills justify-content-center mb-4" id="pills-tab" role="tablist">
            <li class="nav-item m-2" role="presentation"> <a
                ...
                aria-controls="pills-how-much-can-i-recive" aria-selected="true">Program Planning Batch 1</a>
            </li>
            <li class="nav-item m-2" role="presentation"> <a
                ...
                aria-controls="pills-how-much-does-it-costs" aria-selected="true">WEBINAR innovation strategy</a>
            </li>
            <li class="nav-item m-2" role="presentation"> <a
          ...
          <div class="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async"
                      src="{{ asset('web') }}/assets/images/payment-info.png" alt="How Much Can I Recive?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade " id="pills-how-much-does-it-costs" role="tabpanel"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async" src="{{ asset('web') }}/assets/images/illustration-2.png" alt="How Much Does It Costs?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async" src="{{ asset('web') }}/assets/images/illustration-1.png" alt="How Do I Repay?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row position-relative">
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/01.jpg"
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/02.jpg"
                alt="Arlene McCoy" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Freemansyah</h4>
                <p class="mb-0">Web Developer junior</p>
              </div>
            </div>
            <div class="content">Menarik ilmu yang didapat dan dapat sertifikat resmi bisa dijadikan sebagai portofolio juga.</div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/03.jpg"
                alt="Marvin McKinney" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Saepudin</h4>
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/04.jpg"
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/05.jpg"
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3">
              <img loading="lazy" decoding="async"
                src="{{ asset('web') }}/assets/images/testimonials/06.jpg"
  ...
  <section class="section testimonials overflow-hidden bg-tertiary">
    <div class="container">
      ...
      <img loading="lazy" decoding="async"
      src="{{ asset('web') }}/assets/images/lantas.png"
      alt="Leslie Alexander" class="img-fluid" width="105" height="100">&nbsp;&nbsp;
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="shadow rounded py-5 px-4 ms-0 ms-lg-4 bg-white position-relative">
            ...
            <div class="block mx-0 mx-lg-3 mt-4">
              <h4 class="h5">Indonesia Office</h4>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <p>Banyaknya kelas free bersetifkat dari programing hingga desain</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Media Online</h5>
                        <p>Tersebar Media luas secara online bagi klien kami</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <p>Membangun kerja sama dengan berbagai umkn di indonesia</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <p>Penyediaan talenta yang siap kerja dengan berbagai bidang</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('elearning') }}/assets/img/about.jpg" alt="" style="object-fit: cover;">
                </div>
            </div>
        ...
        <div class="row g-3">
                ...
                <div class="row g-3">
                    <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                        <a class="position-relative d-block overflow-hidden" href="">
                            <img class="img-fluid" src="{{ asset('elearning') }}/assets/img/cat-1.jpg" alt="">
                    ...
                    <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                        <a class="position-relative d-block overflow-hidden" href="">
                            <img class="img-fluid" src="{{ asset('elearning') }}/assets/img/cat-2.jpg" alt="">
                            <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                    ...
                    <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                        <a class="position-relative d-block overflow-hidden" href="">
                            <img class="img-fluid" src="{{ asset('elearning') }}/assets/img/cat-3.jpg" alt="">
                            <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
            ...
            <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                <a class="position-relative d-block h-100 overflow-hidden" href="">
                    <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('elearning') }}/assets/img/cat-4.jpg" alt="" style="object-fit: cover;">
                    <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:  1px;">
