...
<div class="section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="mb-5">
            <h2 class="mb-4" style="line-height:1.5">{{ $data['blog']['title'] }}.</h2>
            <span>{{ $data['blog']['created_at']->format('jS F Y') }} <span class="mx-2">/</span> </span>
            <p class="list-inline-item">{{ $data['blog']['categorie_id'] }} : <a href="#!" class="ml-1">Photography </a>
            </p>
          ...
          <div class="mb-5 text-center">
            <div class="post-slider rounded overflow-hidden">
              <img loading="lazy" decoding="async" src="{{ $data['blog']['image_path'] }}" alt="Post Thumbnail">
          ...
          <div class="content">
            <h4 id="heading-example">{{ $data['blog']['title'] }}</h4>
