...
<div class="d-flex justify-content-between align-items-center">
    <div class="logo">
        <a href="index.html"><img src="{{ $app_logo }}" alt="Logo" srcset=""></a>
    </div>
...
<li class="sidebar-item">
    <a href="{{ route('frontend.user.reward.index') }}" class='sidebar-link'>
...
<ul class="submenu ">
    <li class="submenu-item ">
        <a href="{{ route('frontend.mitra.course.index') }}"><i class="bi bi-play"></i>  Webinar</a>
    </li>
    <li class="submenu-item ">
        <a href="{{ route('frontend.mitra.transaction.index') }}"><i class="bi bi-briefcase"></i>  Job</a>
    </li>
</ul>
</li>
